...
const Gallery = () => {
    return (
        <div className='flex flex-col justify-start items-start gap-y-[6px] w-[648px] h-[574px] pr-[4rem]  '>
            <div className='flex relative w-[600px] h-[284px]  '>
                <img className='w-[246px] h-[264px] ml-[px]  mr-[21px]' src='/image/balon.png' alt='' />
